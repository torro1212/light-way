...
const faqs = [
  ...
  },
  {
    ...
    answer: 'התוכניות מתחילות במחזורים. כדי לדעת מתי המחזור הבא מתחיל ולשמור מקום, כדאי ליצור איתי קשר בוואטסאפ. הקבוצות סגורות ומוגבלות ל-10 משתתפים ומשתתפות בלבד, כך שחשוב לתאם מראש.',
  },
];
